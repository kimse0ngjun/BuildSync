      ...
      <div className="admin-dashboard-layout">
        <section className="admin-card pending-card">
          ...
          <div className="admin-pagination">
            <button
              onClick={() => pendingPage > 0 && setPendingPage(pendingPage - 1)}
    ...
    <div className="admin-modal-backdrop">
      <div className="admin-modal">
        ...
        <div className="admin-modal-info">
          <Info label="업체명" value={company.companyName} />
          <Info label="대표자명" value={company.ceoName} />
          <Info label="업체 유형" value={company.companyType} />
          <Info label="사업자번호" value={company.businessNumber} />
          <Info label="연락처" value={company.phone} />
          <Info label="이메일" value={company.email} />
          <Info label="주소" value={company.address} />
          <Info label="홈페이지" value={company.homepageUrl || "-"} />
          <Info label="가입일" value={company.createdAt?.slice(0, 10)} />
        </div>
        ...
        <div className="admin-modal-actions">
          ...
          <button
            ...
            onClick={() => onApprove(company.companyId)}
            disabled={loading}
          >
            승인
          </button>
